...
class MavenLibDownload:
    ...
    libexts: Dict[str, str] = dataclasses.field(default_factory=dict)

    #: Compile time extensions map
    linkexts: Dict[str, str] = dataclasses.field(default_factory=dict)
...
class DistutilsMetadata:
    ...
    * zip_safe - ``False``
    ...
    entry_points: Optional[Dict[str, List[str]]] = dataclasses.field(
...
class RobotpyBuildConfig:
    ...
    #:
    supported_platforms: List[SupportedPlatform] = dataclasses.field(
    ...
    wrappers: Dict[str, WrapperConfig] = dataclasses.field(default_factory=dict)

    static_libs: Dict[str, StaticLibConfig] = dataclasses.field(default_factory=dict)
